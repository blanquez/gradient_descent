...
plt.scatter(x_pos[:,1], x_pos[:,2], c="blue", alpha=0.8, label="1")
plt.scatter(x_neg[:,1], x_neg[:,2], c="yellow", alpha=0.8, label="-1")
plt.title("Grad. descendente estocático")
...
plt.scatter(muestra_pos[:,0],muestra_pos[:,1], c="blue", alpha=0.7, label="1")
plt.scatter(muestra_neg[:,0],muestra_neg[:,1], c="yellow", alpha=0.7, label="-1")
plt.title("Clasificación real de la muestra de entrenamiento")
plt.legend(title="Etiquetas")
plt.show()
...
plt.scatter(muestra_pos[:,1], muestra_pos[:,2], c="blue", alpha=0.7, label="1")
plt.scatter(muestra_neg[:,1], muestra_neg[:,2], c="yellow", alpha=0.7, label="-1")
plt.title("Clasificación resultado de SGD usando características lineales")
plt.legend(title = "Etiquetas")
plt.show()
...
print ('Bondad del resultado para un modelo no lineal:\n')
print ("Ein: ", Err(muestra, y_muestra, w))

plt.scatter(muestra_pos[:,1], muestra_pos[:,2], c="blue", alpha=0.7, label="1")
plt.scatter(muestra_neg[:,1], muestra_neg[:,2], c="yellow", alpha=0.7, label="-1")
plt.title("Clasificación resultado de SGD usando características no lineales")
plt.legend(title="Etiquetas")
plt.show()
